...
mixin _$Language {
 ...
 String? get code; String? get name; String? get nativeName; IconModel? get icon;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Language&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.nativeName, nativeName) || other.nativeName == nativeName)&&(identical(other.icon, icon) || other.icon == icon));
}
...
@useResult
$Res call({
 String? code, String? name, String? nativeName, IconModel? icon
});
...
/// Create a copy of Language
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = freezed,Object? name = freezed,Object? nativeName = freezed,Object? icon = freezed,}) {
  return _then(_self.copyWith(
code: freezed == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
as String?,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,nativeName: freezed == nativeName ? _self.nativeName : nativeName // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? code,  String? name,  String? nativeName,  IconModel? icon)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Language() when $default != null:
return $default(_that.code,_that.name,_that.nativeName,_that.icon);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? code,  String? name,  String? nativeName,  IconModel? icon)  $default,) {final _that = this;
switch (_that) {
case _Language():
return $default(_that.code,_that.name,_that.nativeName,_that.icon);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? code,  String? name,  String? nativeName,  IconModel? icon)?  $default,) {final _that = this;
switch (_that) {
case _Language() when $default != null:
return $default(_that.code,_that.name,_that.nativeName,_that.icon);case _:
  return null;
...
class _Language implements Language {
  const _Language({this.code, this.name, this.nativeName, this.icon});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Language&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.nativeName, nativeName) || other.nativeName == nativeName)&&(identical(other.icon, icon) || other.icon == icon));
}
...
/// Create a copy of Language
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = freezed,Object? name = freezed,Object? nativeName = freezed,Object? icon = freezed,}) {
