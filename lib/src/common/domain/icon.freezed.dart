...
extension IconModelPatterns on IconModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_IconModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? assetName, String? codePoint, String? fontFamily,
            String? color)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _IconModel() when $default != null:
        return $default(
            _that.assetName, _that.codePoint, _that.fontFamily, _that.color);
      case _:
        return orElse();
    }
  }
...
class _IconModel implements IconModel {
  const _IconModel(
      {this.assetName, this.codePoint, this.fontFamily, this.color});
